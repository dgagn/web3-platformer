...
import {coinCollision, gameEmitter} from '../core/collision';
import {
  createAnimations,
  drawSprite,
...
import {time, timer} from '../core/timer';
...
let floor = pipeWith(
  {},
  tag('floor'),
  physics({position: [0, canvas.height - 40]}),
